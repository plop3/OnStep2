...
//         Returns: Nothing
      if ((command[1]>='1') && (command[1]<='4')) { i=command[1]-'1'; int p[] = {10,100,500,1000}; foc1.setMoveRate(constrain(p[i],AXIS4_MIN_MOVE_RATE,1000)); quietReply=true; } else commandError=true;
      } else
#endif
...
//  :fn#   Movement rate, 1=finest, 2=0.01mm/second, 3=0.1mm/second, 4=1mm/second
//         Returns: Nothing
      if ((command[1]>='1') && (command[1]<='4')) { i=command[1]-'1'; int p[] = {10,100,500,1000}; foc2.setMoveRate(constrain(p[i],AXIS5_MIN_MOVE_RATE,1000)); quietReply=true; } else commandError=true;
     } else
#endif
